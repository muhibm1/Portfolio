...
3. **The owner's phone number is published on the page.** It renders in
   ...
   conscious one.
   Digits fully removed under G4-D3. The check is the R89 script, `scripts/check-phone-redaction.mjs`, run by evals GC41 and GC89 of the 2026-09-11 change. The R82 deploy smoke step stays as the generic check in CI.
