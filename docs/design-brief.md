...
Written 2026-09-10 from the owner's request, resume, four mockups in `docs/design/`, and the three
...
- "A mockup website with my experience and focus and a dedicated page for projects and case
  studies."
- Of the mockups in `docs/design/`, "I like the one with the colorful orb" (`docs/design/mockup-home.jpg`)
...
(`docs/design/mockup-mmlogo.jpg`) rather than the orb the owner chose.
...
2. **Hero** per `docs/design/mockup-home.jpg`: stacked uppercase name, "Forward Deployed Engineer &
...
3. **Pages** (needs a router; none installed):
   ...
   - `/work` dedicated projects and case studies index, Reis layout, filterable by type
     (Case study / Project).
   - `/work/:slug` dedicated case study page per `docs/design/mockup-casestudy.jpg`: eyebrow, large
